          ...
          <div class="row">
            <div class="col-lg-6 col-md-6">
              <div class="header__top__left">
                <ul>
                  <li><i class="fa fa-envelope"></i>5men@gmail.com</li>
                  <li>Giao hàng miễn phí cho tất cả đơn hàng trên 250k</li>
                </ul>
              </div>
            </div>
            <div class="col-lg-6 col-md-6">
        ...
        <div class="row">
          ...
          <div class="col-lg-3">
            <div class="header__cart">
              ...
              <div class="header__cart__price">Gíá: <span>${{ $cartTotal }}</span></div>
            </div>
          </div>
        </div>
        ...
        <div class="row">
          <div class="col-lg-3 col-md-6 col-sm-6">
            <div class="footer__about">
              ...
              <ul>
                <li>Địa chỉ: Đường cách mạng tháng 8, quận 3, thành phố HCM</li>
                <li>Điện thoại:1234567</li>
